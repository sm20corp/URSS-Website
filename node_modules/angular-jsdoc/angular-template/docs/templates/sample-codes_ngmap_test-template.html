...
<html>
  <head>
    <meta charset="utf-8">
    <base href="../">
    <title>JSDoc: template : sample-codes/ngmap/test-template.html</title>
  ...
  <body ng-app="">
    ...
    <div id="content" class="page-wrap">
      <h1 class="title">
        template : sample-codes/ngmap/test-template.html
      </h1>
      <div id="main" class="big-container">
        <!-- source code html -->
        <article>
          <pre class="prettyprint source linenums"><code>&lt;this>
  &lt;is>Hello&lt;/is>
  &lt;test>World&lt;/test>
