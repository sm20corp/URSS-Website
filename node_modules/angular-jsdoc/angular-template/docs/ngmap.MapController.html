    ...
    <table class="params">
      ...
      <tbody>
        <tr>
          ...
          <td class="description last">
            <span>
              <p>Converts element attributes to Google Maps API options</p>
            </span>
          </td>
        </tr>
      </tbody>
...
<div class="functions">
  ...
  <dl>
    <dt>
      <a href="source/ngmap.MapController.html#line21" class="name-link" id="addObject">
        <h4 class="name">
          addObject
        </h4>
      </a>
    ...
    <dt>
      <a href="source/ngmap.MapController.html#line32" class="name-link" id="deleteObject">
        <h4 class="name">
          deleteObject
        ...
        <table class="params">
          ...
          <tbody>
            <tr>
              ...
              <td class="description last">
                <span>
                  <p>the collection of objects. i.e., map.markers</p>
                </span>
              </td>
            </tr><tr>
              ...
              <td class="description last">
                <span>
                  <p>the object to be removed. i.e., marker</p>
                </span>
              </td>
            </tr>
          </tbody>
    ...
    <dt>
      <a href="source/ngmap.MapController.html#line43" class="name-link" id="getGeoLocation">
        <h4 class="name">
          getGeoLocation
        ...
        <table class="params">
          ...
          <tbody>
            <tr>
              ...
              <td class="description last">
                <span>
                  <p>an address to find the location</p>
                </span>
              </td>
            </tr>
          </tbody>
        ...
        <table class="params">
          ...
          <tbody>
            <tr>
              ...
              <td class="description last">
                <span>
                  <p>latlng the location of the address</p>
                </span>
              </td>
            </tr>
          </tbody>
