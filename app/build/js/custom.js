...
$(document).ready(function() {
    ...
    $SIDEBAR_MENU.find('a').on('click', function(ev) {
        ...
        if ($li.is('.active')) {
            ...
            if (!$li.parent().is('.child_menu')) {
                $SIDEBAR_MENU.find('li').removeClass('active active');
    ...
    $MENU_TOGGLE.on('click', function() {
        if ($BODY.hasClass('nav-md')) {
            ...
            $SIDEBAR_MENU.find('#username_login').hide();
            $SIDEBAR_MENU.find('#username_password').hide();
            $SIDEBAR_MENU.find('#connect_row').hide();
            $SIDEBAR_MENU.find('#subscribe_row').hide();

            //$SIDEBAR_MENU.find('li.active').addClass('active').removeClass('active');
        } else {
            $SIDEBAR_MENU.find('li.active-sm ul').show();
            $SIDEBAR_MENU.find('#username_login').show();
